    ...
    <section id="home" className="relative w-full py-12 md:py-20 px-6 md:px-12 flex flex-col items-center justify-center overflow-hidden bg-background">
      ...
      <div className={`relative z-10 max-w-4xl text-center space-y-6 transition-all duration-700 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-medium tracking-tighter text-balance text-foreground">
          Software development for <span className="text-primary">modern</span> businesses
        </h1>
        
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto text-balance">
          From mobile apps to web platforms, we craft custom software solutions that drive innovation and accelerate your business growth. Let's build something amazing together.
        </p>
      ...
      {/* Development Dashboard UI integrated in hero section with glassmorphic effect */}
          ...
          <div className="bg-card backdrop-blur-md w-full">
            <div className="flex items-center justify-between p-4 border-b border-border">
              <div className="flex items-center gap-4">
                ...
                <span className="text-foreground font-medium">Development Project Pipeline</span>
              </div>
              ...
              <div className="flex-1 p-4 bg-background overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-6 min-w-0">
                  <div className="flex items-center gap-2 flex-shrink-0">
                    <h3 className="font-medium text-foreground">Development Tasks</h3>
